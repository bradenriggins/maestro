...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("x")+descStyle.Render("         - Kill (delete) the selected session"),
...
func (h helpTypeInstanceStart) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		"",
		headerStyle.Render("Handoff:"),
		keyStyle.Render("p")+descStyle.Render("     - Pause this instance (commit changes locally)"),
...
func (h helpTypeInstanceCheckout) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("p")+descStyle.Render(" - Pause: commit changes locally and pause session"),
		keyStyle.Render("r")+descStyle.Render(" - Resume a paused session"),
	)
	return content
}
