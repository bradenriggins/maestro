...
func TestTabbedWindowSetSizeUsesFullAssignedDimensions(t *testing.T) {
	...
	expectedContentWidth := 90 - windowStyle.GetHorizontalFrameSize()
	expectedContentHeight := 20 - (activeTabStyle.GetVerticalFrameSize() + 1) - windowStyle.GetVerticalFrameSize()
